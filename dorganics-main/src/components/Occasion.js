...
const Occasion = () => {
  ...
  console.log('Height:', height);
    ...
    const handleSelect = (option) => {
      setSelected(option);
      navigate('/Event', { state: {  currentWeight, desiredWeight: desiredWeight, height } });
    }
    return (
      <div className="Occasion-Container">
        ...
        <div className="Occasion-Options">
          {options.map((option) => (
            ...
            >
             <img src={option.image} alt={option.label}   style={{ width: '50px', height: '50px', marginRight: '-140px', verticalAlign: 'middle' }} />  
              {option.label}
...
const Occasion = () => {
  ...
  const handleSelect = (option) => {
    setSelected(option);
    navigate('/Event', { state: { currentWeight, desiredWeight, height } });
  };
